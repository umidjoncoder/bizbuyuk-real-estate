              ...
              <Reveal key={p.slug} delay={0.05 * i}>
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col p-6 sm:p-7">
                    ...
                    <h2 className="mt-3 text-[1.15rem] font-extrabold leading-snug tracking-tight text-coal">{p[TITLE_KEY[loc]] as string}</h2>
                    <p className="mt-2.5 line-clamp-3 flex-1 text-[0.9rem] leading-relaxed text-muted-dark">{p[BODY_KEY[loc]] as string}</p>
