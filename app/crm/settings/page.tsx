...
import { DEFAULT_SOURCES, DEFAULT_DEVELOPERS, DEFAULT_PROPERTY_TYPES } from "@/lib/options";
...
export default function SettingsPage() {
  ...
  const [custom, setCustom] = useState<{ leadSource: Opt[]; developer: Opt[]; propertyType: Opt[] }>({ leadSource: [], developer: [], propertyType: [] });
  ...
  const load = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setCustom({ leadSource: d.leadSource || [], developer: d.developer || [], propertyType: d.propertyType || [] });
        setLogo(d.logo || null);
      }
