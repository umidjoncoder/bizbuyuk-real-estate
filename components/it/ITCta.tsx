  ...
  return (
    <section ref={ref} className="relative overflow-hidden border-t border-line">
      ...
      <div className="relative z-10 mx-auto max-w-[1280px] px-5 py-28 sm:px-8 sm:py-36">
        ...
        <Reveal delay={0.08}>
          <p className="mt-6 max-w-[46ch] text-[1.1rem] leading-relaxed text-muted">{c.body}</p>
        </Reveal>
        <Reveal delay={0.16}>
          <div className="mt-10 flex flex-wrap items-center gap-4">
            <a
              href={`${CONTACT.whatsappIt}?text=${encodeURIComponent(c.title)}`}
              target="_blank"
