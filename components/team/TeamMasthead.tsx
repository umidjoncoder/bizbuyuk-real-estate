...
export function TeamMasthead() {
  const { t } = useLang();
  return (
    <section className="mx-auto max-w-[1280px] px-5 pb-14 pt-32 sm:px-8 sm:pt-36">
      <Reveal>
      ...
      <Reveal delay={0.08}>
        <h1 className="display mt-6 max-w-[16ch] text-[clamp(2.4rem,5.8vw,4.6rem)] text-cream">
